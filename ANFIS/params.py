...
class FuzzyInputVariable_3Trapezoids:
    ...
    def show(self, x=None):
        ...
        plt.title(f"Linguistic variable {self.name}")
    ...
    def fuzzify(self, x:Union[float, np.ndarray]) -> np.ndarray:
        ...
        # return in form of matrix, column = membership
...
class FuzzyInputVariable_2Trapezoids:
    ...
    def __init__(self, center: float, fuzzyWidth: float, name: str, labels: List[str]):
        """
        FuzzyInputVariable_2Trapezoids constructor method for 2 trapezoidal membership functions
        :param center: center of the membership function
        :param fuzzyWidth: fuzzy width of the membership function
        :param name: name of the linguistic variable
        :param labels: list of labels for the membership functions
        """
        self.c = center
        self.fw = fuzzyWidth
        self.name = name
    ...
    def set(self, center: float, fuzzyWidth: float):
        """
        Set method for the FuzzyInputVariable_2Trapezoids class
        :param center: center of the membership function
        :param fuzzyWidth: fuzzy width of the membership function
        :return:
        """
    ...
    def getFunctionsList(self, leftBound=-10, rightBound=10):
        """
        Get method for the FuzzyInputVariable_2Trapezoids class to get the list of membership functions
        :param leftBound: left bound of the membership function
        :param rightBound: right bound of the membership function
        :return:
        """
    ...
    def fuzzify(self, x:Union[float, np.ndarray]) -> np.ndarray:
        ...
        # return in form of matrix, columns = memberships
